...
class FlexStuff extends React.Component {
    ...
    render() {
        ...
        console.log('passed params was', params)
        ...
        return (
            <Container maxWidth="sm">
                ...
                <Grid container direction="row" justify="space-between" alignItems="flex-end">
                    ...
                    <Button
                        onClick={() => {
                            this.setState({ justify: 'flex-end' })
                        }}>
                        Justify End
                    </Button>
                    <Button
                        onClick={() => {
                            this.setState({ justify: 'space-between' })
                        }}>
                        Justify Space Between
                    </Button>
                    <Button
                        onClick={() => {
                            this.setState({ justify: 'space-around' })
                        }}>
                        Justify Space Around
                    </Button>
                    <Button
                        onClick={() => {
                            this.setState({ justify: 'space-evenly' })
                        }}>
                ...
                <Grid container direction="row" justify="space-between" alignItems="flex-end">
                    ...
                    <Button
                        onClick={() => {
                            this.setState({ alignItems: 'stretch' })
                        }}>
                        Align Stretch
                    </Button>
                    <Button
                        onClick={() => {
                            this.setState({ alignItems: 'baseline' })
                        }}>
                        Align Baseline
                    </Button>
                </Grid>
